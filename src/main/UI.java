...
public class UI {
	...
	BufferedImage heart_blank,heart_half,heart_full, heart_STRINGheart_blank, crystal_full, crystal_blank, coin;
	...
	public void drawLevel()
	{
		...
		g2.setColor(Color.black);
		g2.drawString("Level: " + value , x+2, y+2);
		g2.setColor(Color.white);
		g2.drawString("Level: " + value , x, y);
	}
	...
	public void trade_buy()
	{
		...
		if(itemIndex < npc.inventory.size())
		{
			...
			if(gp.keyH.enterPressed == true)
			{
				...
				{
					if(gp.player.canObatinItem(npc.inventory.get(itemIndex)) == true)
					{
