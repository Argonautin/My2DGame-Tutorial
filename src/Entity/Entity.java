...
public class Entity {
	...
	public void update() 
	{
		if(sleep == false)
		{
			...
			else
			{
				setAction();
				checkCollision();
				// IF COLLISION IS FALSE, CHARACTER CAN MOVE
	...
	public void checkShoot(int rate, int shotIntervale)
	{
		int i = new Random().nextInt(rate);
		if(i == 0 && projectile.alive == false && shotAvailableCounter == shotIntervale)
		{
	...
	public String getOppositeDirection(String direction)
	{
		...
		case "down": oppositeDirection = "down"; break;
		case "left": oppositeDirection = "down"; break;
		case "right": oppositeDirection = "down"; break;
		}
	...
	public BufferedImage setupAttackImage(String imagePath, int width, int height)
	{
		UtilityTool uTool = new UtilityTool();
		BufferedImage image = null;
